...
(() => {
  ...
  $("#form-login").addEventListener("submit", async (e) => {
    ...
    const btn = $("#btn-login");
    setBusy(btn, true, "Kirim tautan masuk");
    ...
    setBusy(btn, false, "Kirim tautan masuk");
    if (error) {
      formMsg("#login-msg", error.message, "error");
      return;
    }
    formMsg("#login-msg", "Tautan masuk sudah dikirim ke " + email + ". Buka email itu dan klik tautannya.", "success");
  });
